...
export default function AboutSection() {
  ...
  const skills = ["React", "Node.js", "TypeScript", "Tailwind", "Next.js", "Laravel"];
  const stats = [
          ...
          <div className="relative w-72 h-72 md:w-[380px] md:h-[480px] lg:w-[420px] lg:h-[520px] rounded-[1.5rem] overflow-hidden bg-neutral-900 border border-white/10 shadow-2xl group">
            ...
            <div className="absolute bottom-6 left-6 right-6">
              <div className="flex items-center gap-2 px-4 py-2 rounded-full bg-neutral-950/60 backdrop-blur-md border border-white/10 w-fit shadow-lg">
                ...
                <span className="text-sm font-medium text-neutral-200">Available for work</span>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="flex flex-col gap-10">
            ...
            <div className="space-y-5">
              ...
              <p className="text-xl text-neutral-400 leading-relaxed max-w-2xl">
                A passionate full-stack developer who loves building clean, performant web experiences. I specialize in React, Node.js, and turning ideas into polished digital products.
              </p>
            </div>

            {/* Skills */}
            <div className="space-y-4">
              <h3 className="text-sm font-semibold text-neutral-500 uppercase tracking-wider">Tech Stack</h3>
            ...
            {/* CTA */}
            <div className="pt-4">
              <button className="group relative inline-flex items-center justify-center px-10 py-4 text-base font-semibold text-white transition-all duration-200 bg-neutral-900 rounded-full hover:bg-neutral-800 hover:ring-2 hover:ring-offset-2 hover:ring-offset-neutral-900 hover:ring-purple-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-purple-500 border border-white/10">
